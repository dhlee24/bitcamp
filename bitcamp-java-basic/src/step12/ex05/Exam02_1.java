...
public class Exam02_1 {
	public static void main(String[] args) {
		...
		// ㄴ> Iterator의 장점 : 일관된 규칙(Interface)로 값을 꺼낼 수 있다.
		// ArrrayList(get()), Stack(pop()), Queue(poll()) <= 값을 꺼내는 방법(규칙)이 모두 다르다.
		// Iterator를 이용하면 hasNext(), next()로 일관된 규칙으로 값을 꺼낼 수 있다.
